...
def empty_data():
    ...
    return pd.DataFrame(columns=["work_year", "salary_in_usd", "job_title", "experience_level", "company_size", "remote_ratio", "company_location"])
...
def test_update_charts_empty_data(empty_data):
    ...
    # Ensure the empty chart is returned properly
